...
## Project Structure
    ...
    ├── misty_limit_dev_114601  # Django project configurations
...
1. Clone this repo and `cd misty_limit_dev_114601`
...
2. Clone this repo and `cd misty_limit_dev_114601`
